...
public interface StockMapper {
    ...
    @Select("select id,stock_name,stock_code,stock_code_str,now_price,last_price,stock_status from stock_info where search_str like concat(concat('%',#{queryStr}),'%') limit 0,10")
    List<StockBean> queryStockFuzzy(@Param("queryStr") String queryStr);
