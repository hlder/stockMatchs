...
//                System.out.println("请求成功");
                ...
                return BaseController.ERROR_SEND_SMS_AUTH_CODE_OVER;
            }else if(sendSmsResponse.getCode() != null && sendSmsResponse.getCode().equals("isv.MOBILE_NUMBER_ILLEGAL")){
                return BaseController.ERROR_SEND_SMS_AUTH_CODE_PHONE;
            }
        } catch (ClientException e) {
            e.printStackTrace();
        }
        return BaseController.ERROR_SEND_SMS_AUTH_CODE;
    }
}
